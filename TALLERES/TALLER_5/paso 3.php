...
// 8. Función para identificar a los estudiantes que necesitan tutoría
...
// 9. Función para identificar a los estudiantes de honor
...
echo "\nEstudiantes que necesitan tutoría: " . (empty($estudiantesTutoria) ? "Ninguno" : implode(", ", $estudiantesTutoria)) . "\n";

// 11. Mostrar estudiantes de honor
$estudiantesHonor = estudiantesDeHonor($estudiantes);
echo "Estudiantes de honor: " . (empty($estudiantesHonor) ? "Ninguno" : implode(", ", $estudiantesHonor)) . "\n";
?>
